...
sections:
  ...
  - block: markdown
    content:
      title: '学术简历'
      text: |-
        杨朋卫是悉尼大学传感器、云计算与服务实验室的助理研究员。杨朋卫曾是悉尼大学计算机科学学院Athman Bouguettaya教授指导下的研究型硕士生，拥有深厚的计算机科学与电子信息科学交叉学科背景。作为悉尼大学传感器、云和服务实验室的研究员，杨朋卫的学术追求是探索计算机科学的各个层面，包括众包、服务计算、深度学习和可信机器学习。
